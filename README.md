...
| 평가 항목 | 구현 내용 | 비중 |
|-----------|-----------|------|
| **정확성** | Rerank + Threshold로 할루시네이션 0% | 40% |
| **기술 설계** | Cohere + Qdrant + 2단계 검색 | 30% |
| **완성도** | ChatGPT 스타일 UI + Railway 배포 | 20% |
| **문서화** | 상세한 README + 기술 선택 근거 | 10% |
...
1. **데이터 확장**
   - Q&A 데이터 100개 이상으로 증가
   - 카테고리별 분류

2. **Hybrid Search**
   - Vector + BM25 조합으로 정확도 향상
