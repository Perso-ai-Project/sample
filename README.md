...
🏗️ 시스템 아키텍처
사용자 질문 ↓ 질의 벡터화 (Cohere Embedding API) ↓ Vector DB 검색 (Qdrant - Cosine Similarity) ↓ Top-K 후보 추출 (K=5) ↓ Rerank로 정확도 향상 (Cohere Rerank API) ↓ 최적 답변 선택 (Threshold 0.7) ↓ UI 출력 (ChatGPT 스타일)
